...
create table if not exists public.recurring_transactions (
  ...
  account_id text not null references public.family_accounts(id) on delete cascade,
  target_account_id text references public.family_accounts(id) on delete cascade,
